...
def get_text2image_response(pecha_id, pagination_layer):
    text2image_response = {
        'id': pecha_id,
        'type': "image",
        'alignment' : []
    ...
    text2image_response['alignment'] = alignments
    return text2image_response
...
def serialize_pagination_layer_to_json(opf_id, opf_path, json_path):
    ...
    for base_name in base_names:
        ...
        text2image_response = get_text2image_response(opf_id, pagination_layer)
        text2image_response = json.dumps(text2image_response, ensure_ascii=False)
        json_path.write_text(text2image_response, encoding='utf-8')
